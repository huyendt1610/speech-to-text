...
from ..utils.w2vec2_utils import (
    W2Vec2Config,
...
if __name__ == "__main__":
    from ..utils.w2vec2_utils import W2Vec2Config
    from ..dataset.w2vec2 import W2Vec2LibriDataset, W2Vec2CollateFunctionForPreTraining
